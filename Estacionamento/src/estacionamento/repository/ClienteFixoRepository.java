...
public class ClienteFixoRepository implements Rest<ClienteFixo>{
        
    public static final String FILE_NAME = "clientesFixo.json";
    ...
    @Override
    public boolean createClient(ClienteFixo client) {
        Gson gson = new Gson();
    ...
    public boolean deleteClcient(String cpf) {
        ...
        jsonClients.forEach((JsonElement element) -> {
            ClienteFixo cliente = gson.fromJson(element, ClienteFixo.class);
